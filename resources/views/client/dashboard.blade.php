                    ...
                    <div class="wrap-count flex-wrap flex">
                        <div class="box tf-counter flex  bg-white">
                                ...
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_1523_44774)">
                                        <path
                                            ...
                                            fill="#1C1C1E" stroke="white" stroke-width="0.7" />
                                        <path
                            ...
                            <div class="counter-box one ">
                                ...
                                <div class="count-number flex">
                                    <div class="number number-one" data-speed="2000" data-to="32" data-inviewport="yes">
                                    </div>
                        ...
                        <div class="box tf-counter flex  bg-white">
                            ...
                            <div class="counter-box one ">
                                ...
                                <div class="count-number">
                                    <div class="number number-one" data-speed="2000" data-to="02" data-inviewport="yes">02
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="box tf-counter flex  bg-white">
                            ...
                            <div class="counter-box one ">
                                ...
                                <div class="count-number">
                                    <div class="number number-one" data-speed="2000" data-to="06" data-inviewport="yes">06
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="box tf-counter flex  bg-white">
                            ...
                            <div class="counter-box one ">
                                ...
                                <div class="count-number">
                                    <div class="number number-one" data-speed="2000" data-to="1483"
                ...
                <div class="col-lg-12 flex post-col">
                    ...
                    <div class="tf-new-listing ">
                        <div class="new-listing bg-white">
                            ...
                            <div class="sub-text fs-12 lh-18 "><span class="one font-2 fw-7">26</span>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex">
                                                        <div class="images">
                                                            <img src="/front/assets/images/house/dashboard-house-1.jpg"
                                                                alt="images">
                                                        </div>
                                                        <div class="content">
                                                            <h4 class="link-style-1"><a
                                                                    href="property-detail-v1.html">Gorgeous
                                                                    Apartment Building</a> </h4>
                                                            <div class="text-date">
                                                                <p class="p-12 text-color-2 lh-18">Posting
                                                                    date: March 22, 2023</p>
                                                            </div>
                                                    ...
                                                    <div class="icon-wrap">
                                                        <ul class="">
                                                            <li class=""><a class="fw-6"><i
                                                                        class="far fa-pen"></i>Edit</a>
                                                            </li>
                                                            <li class=""><a class="fw-6"><i
                                                                        class="fal fa-ban"></i>Sold</a>
                                                            </li>
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex">
                                                        <div class="images">
                                                            <img src="/front/assets/images/house/dashboard-house-2.jpg"
                                                                alt="images">
                                                        </div>
                                                        <div class="content">
                                                            <h4 class="link-style-1"><a
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex">
                                                        <div class="images">
                                                            <img src="/front/assets/images/house/dashboard-house-3.jpg"
                                                                alt="images">
                                                        </div>
                                                        <div class="content">
                                                            <h4 class="link-style-1"><a
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex">
                                                        <div class="images">
                                                            <img src="/front/assets/images/house/dashboard-house-4.jpg"
                                                                alt="images">
                                                        </div>
                                                        <div class="content">
                                                            <h4 class="link-style-1"><a
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex">
                                                        <div class="images">
                                                            <img src="/front/assets/images/house/dashboard-house-5.jpg"
                                                                alt="images">
                                                        </div>
                                                        <div class="content">
                                                            <h4 class="link-style-1"><a
                            ...
                            <ul>
                                <li>
                                    <div class="image-box flex align-center">
                                        <div class="images">
                                            <img src="/front/assets/images/author/author-list-3.jpg" alt="images">
                                        </div>
                                        <div class="title-flat fw-6">Themesflat</div>
                                        <p class="fs-12 lh-18">3 day ago</p>
                                    </div>
                                    <div class="content">
                                        <p class="text-color-2">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Aenean scelerisque vulputate tincidunt.
                                            Maecenas lorem sapien</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="image-box flex align-center">
                                        <div class="images">
                                            <img src="/front/assets/images/author/author-dashboard-top.jpg"
                                                alt="images">
                                        </div>
                                    ...
                                    <div class="content">
                                        <p class="text-color-2">Nullam lacinia lorem id sapien suscipit,
                                            vitae pellentesque metus maximus. Duis eu mollis dolor. Proin
                                            faucibus eu lectus a eleifend</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="image-box flex align-center">
                                        <div class="images">
                                            <img src="/front/assets/images/author/author-list-1.jpg" alt="images">
                                        </div>
                                        <div class="title-flat fw-6">Cameron Williamson</div>
                                        <p class="fs-12 lh-18">3 day ago</p>
                                    </div>
                                    <div class="content">
                                        <p class="text-color-2">In consequat lacus augue, a vestibulum est
                                            aliquam non</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="image-box flex align-center">
                                        <div class="images">
                                            <img src="/front/assets/images/author/author-10.jpg" alt="images">
                                        </div>
                                        <div class="title-flat fw-6">Esther Howard</div>
                                        <p class="fs-12 lh-18">3 day ago</p>
                                    </div>
                                    <div class="content">
                                        <p class="text-color-2">Cras congue in justo vel dapibus. Praesent
                                            euismod, lectus et aliquam pretium</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="reviews-sidebar messages-sidebar bg-white">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="content">
                                        <p class="text-color-2">Maecenas eu lorem et urna accumsan
                                            vestibulum vel vitae magna. </p>
                                        <div class="star flex">
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <p class="text-color-2">Nullam rhoncus dolor arcu, et commodo
                                            tellus semper vitae. Aenean finibus tristique lectus, ac
                                            lobortis mauris venenatis ac. </p>
                                        <div class="star flex">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <p class="text-color-2">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Vivamus viverra semper convallis. Integer
                                            vestibulum tempus tincidunt. </p>
                                        <div class="star flex">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <p class="text-color-2">Fusce sit amet purus eget quam eleifend
                                            hendrerit nec a erat. Sed turpis neque, iaculis blandit viverra
                                            ut, dapibus eget nisi.</p>
                                        <div class="star flex">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                ...
                                <li>
                                    <div class="image-box flex align-center">
                                        <div class="images">
                                            <img src="/front/assets/images/author/author-11.jpg" alt="images">
                                        </div>
                                        <div class="title-flat fw-6">Albert Flores</div>
                                        <p class="fs-12 lh-18">3 day ago</p>
                                    </div>
                                    <div class="content">
                                        <p class="text-color-2">Donec bibendum nibh quis nisl luctus, at
                                            aliquet ipsum bibendum. Fusce at dui tincidunt nulla semper
                                            venenatis at et magna. Mauris turpis lorem, ultricies vel justo
                                            sed.</p>
                                        <div class="star flex">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
