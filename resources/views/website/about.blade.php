...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-inner ">
                        <div class="title-group fs-12"><a class="home fw-6 text-color-3" href="/">Accueil</a><span>A
                                propos</span></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="wrap-info">
                            ...
                            <div class="icon-info">
                                <svg width="50" height="51" viewBox="0 0 50 51" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#8E8E93" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round"
                        ...
                        {{-- <div class="box-info flex align-center">
                            ...
                            <div class="content">
                                ...
                                <a href="info:alkebulan.eca@gmail.com">
                                    <h4 class="fw-4 text-color-3"><span>alkebulan.eca@gmail.com</span>
                                    </h4>
                                </a>
                            </div>
                        </div> --}}
    ...
    <section class="flat-map">
        <div class="container-fuild">
            ...
            <iframe class="map-content" src="https://maps.google.com/maps?q=6.197219,1.191198&hl=es;z=14&amp;output=embed"
