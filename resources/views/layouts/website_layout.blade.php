...
<body class="body  ">
    ...
    <script src="/front/app/js/owl.js"></script>
    <script src="/front/app/js/swiper-bundle.min.js"></script>
    <script src="/front/app/js/swiper.js"></script>
    <script src="/front/app/js/jquery-validate.js"></script>

    <script src="/front/app/js/jquery.fancybox.js"></script>
