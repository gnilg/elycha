...
<head>
    <title>Elycha || Privacy Policy</title>
    ...
    <link rel="stylesheet" href="/maps/dist/leaflet-locationpicker.src.css" />
            ...
            <div class="col-lg-12">
                ...
                <div class="about-us-text">
                    ...
                    <p>
                        ...
                        The users of the Elycha app grant their consent for the processing of their
                        personal data during the installation of the Elycha app.
                        Your personal data is collected and processed by the company, Elycha
                        Pte. Ltd. Elycha Pte. Ltd. only collects and processes the personal data
                        submitted by the users in the course of installation and use of the Elycha
                        app. A user's disclosure of geographical location data is a precondition for
                        using the Elycha app. <br>
                        <b>1. What type of personal data we collect and process</b><br>
                        Name, telephone number, e-mail address, feedback ratings and/or
                        payment information of the app user;
                        Geographical location of the user, the time of provision of service and
                        the destination;
                        Identification data of the device on which the Elycha app has been
                        installed;
                        Cookies of the Elycha.co website may save the website user's
                        geographic location data and other available web browsing data. <br>
                        <b> 2. The purpose of collecting and the period of processing of
                            personal data </b><br>
                        ...
                        issues;
                        We use contact details to notify you of updates to the Elycha app;
                        We collect data of the routes taken by the Elycha app users to
                        ...
                        you. <br>
                        <b>3. The method of collecting personal data</b><br>
                        ...
                        is closed in the user's device. <br>
                        <b>4. Disclosure of personal data to third parties</b><br>
                        ...
                        handed over to the relevant local entities providing Elycha app
                        services. Any collection and processing of personal data by local
                        Elycha service providers shall occur under the same conditions as
                        ...
                        an alleged crime. <br>
                        <b>5. Security and deletion of data</b><br>
                        Any personal data collected in the course of providing the Elycha
                        service is transferred to and stored in the data centres located in the
                        territory of England. Only authorised employees of Elycha and local
                        ...
                        with the use of the Elycha app (including disputes with the drivers);
                        Elycha takes all necessary precautions to ensure the confidentiality
                        ...
                        features.
                        Please note that uninstalling the Elycha app from your device does
                        ...
                        Elycha, please send a written request to close your account and
                        ...
                        result, you will no longer be able to use Elycha services under your
                        existing account. After the deletion, the personal data will be
                        anonymized and used for analytics only.
                        If you presume that we (or any other Elycha entity processing your
                        ...
                        personal data is inaccurate, you may:<br>
                        a) ask us (and/or any other Elycha entity processing your
                        personal data) for an explanation;<br>
                        b) require us (and/or any other Elycha entity processing your
                        personal data) to remedy the arisen state of affairs (in particular
                        by blocking, correction or supplementing of personal data);<br>
                        c) appeal directly to the respective data protection authority
                        having the jurisdiction over your personal data. <br>
                        <b>Direct marketing</b><br>
                        ...
                        section of Elycha mobile App. <br>
                        <b>7. Personal data of taxi drivers</b><br>
                        ...
                        purposes:
                        To enable the normal operation of the Elycha App;
                        To deliver the Elycha Services to their attention and that of the
                        Clients;
                        ...
                        Elycha´s service providers shall occur under the same conditions as
                        established in this privacy policy.
                        Using the Elycha app with dispatch feature, a service operator can
