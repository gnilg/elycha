<header id="header" class="main-header home2 header  header-fixed style-absolute  ">
                    ...
                    <div class="inner-container flex justify-space align-center">
                        ...
                        <div class="flex">
                            <div class="icon-socials box-3 text-color-1 flex align-center ">
                                <a target="_blank" href="https://www.facebook.com/profile.php?id=61554554742886"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" href="https://www.linkedin.com/in/alkebulan-eca-9a644b2a6/"><i class="fab fa-linkedin-in"></i></a>
                                <a target="_blank" href="https://www.instagram.com/alkebulan.eca/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo">
                <a href="/"><img src="/front/assets/images/logo/logo2-1.png" alt=""
                        width="197" height="48"></a>
                    </div>
