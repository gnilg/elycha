                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Publications auto</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Publications auto</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">Publications auto</h4>
                                    ...
                                    <div class="modal fade" id="boostCard{{ $post->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Etes-vous sûr de booster la publication
                                                        <b>{{ $post->label }}</b> ?
                                                    </p>
                                                </div>
                                                <div class="modal-footer bg-whitesmoke br">
